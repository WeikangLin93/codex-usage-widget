...
$configPath = Join-Path $PSScriptRoot "widget_config.json"
$defaultConfig = @{
  opacity = 0.90
  layer_mode = "topmost"
...
function Refresh-Usage {
  try {
    ...
    if ($py) {
      $json = & py -3 "$PSScriptRoot\codex_usage_fetch.py" 2>$null
    } else {
      $json = & python "$PSScriptRoot\codex_usage_fetch.py" 2>$null
    }
...
function Update-NotifyText {
  ...
  $status = if ($script:usage.ok) { if ($script:usage.from_cache) { "缓存" } else { "正常" } } else { "异常" }
...
$form.Add_Paint({
  ...
  $subBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(158,158,158))
  $okBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(138,214,170))
  $cacheBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(214,198,138))
  $badBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(217,150,150))
  $modeBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(176,203,255))
  ...
  $trackPenOuter = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(60,60,60), 9)
  $progressPenOuter = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(84,184,255), 9)
  $trackPenInner = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(70,70,70), 7)
...
$timer.Add_Tick({
  ...
  if ((Get-Date).Second -eq 0) { Refresh-Usage }
})
$timer.Start()
